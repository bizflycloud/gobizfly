...
// Configuration Resource Action Path
...
// Backup resourceType Create Path
...
type CloudDatabaseInstanceCreate struct {
	...
	Datastore        CloudDatabaseDatastore    `json:"datastore,omitempty"`
	EnableFailover   bool                      `json:"enable_failover,omitempty"`
	FlavorName       string                    `json:"flavor_name,omitempty"`
	InstanceType     string                    `json:"instance_type,omitempty"`
	Name             string                    `json:"name,omitempty"`
	Networks         []CloudDatabaseNetworks   `json:"networks,omitempty"`
...
type CloudDatabaseConfigurationCreate struct {
	...
	ConfigurationParameters map[string]interface{} `json:"configuration_parameters,omitempty"`
	Datastore               CloudDatabaseDatastore `json:"datastore,omitempty"`
}
...
type CloudDatabaseScheduleCreate struct {
	...
	LimitBackup  int    `json:"limit_backup,omitempty"`
...
// CloudDatabaseTrustedSource contains TrustedSource information of node.
type CloudDatabaseTrustedSource struct {
...
// CloudDatabaseEngineType contains detail about a datastore.
type CloudDatabaseEngineType struct {
	ID       string                       `json:"id"`
	Name     string                       `json:"name"`
	Versions []CloudDatabaseEngineVersion `json:"versions"`
}

// CloudDatabaseEngine contains datastore info.
type CloudDatabaseEngine struct {
	Engines []CloudDatabaseEngineType `json:"engines"`
}
...
// Action with a nodes.
func (no *cloudDatabaseNodes) Action(ctx context.Context, nodeID string, iar *CloudDatabaseAction) (*CloudDatabaseMessageResponse, error) {
...
func (sc *cloudDatabaseSchedules) List(ctx context.Context, resource *CloudDatabaseScheduleListResourceOption, opts *CloudDatabaseListOption) ([]*CloudDatabaseSchedule, error) {
	...
	default:
		return nil, errors.New("Can't determine schedule resource list option")
	}
...
// Get TrustedSource.
func (ts *cloudDatabaseTrustedSources) Get(ctx context.Context, nodeID string) (*CloudDatabaseTrustedSource, error) {
	...
	defer resp.Body.Close()
	var trustedSources *CloudDatabaseTrustedSource
...
func (ts *cloudDatabaseTrustedSources) Create(ctx context.Context, nodeID string, fwc *CloudDatabaseTrustedSource) (*CloudDatabaseTrustedSource, error) {
	req, err := ts.client.NewRequest(ctx, http.MethodPost, databaseServiceName, ts.resourcePath(nodeID), &fwc)
	if err != nil {
		return nil, err
	}
	resp, err := ts.client.Do(ctx, req)
...
func (ts *cloudDatabaseTrustedSources) Update(ctx context.Context, nodeID string, fwc *CloudDatabaseTrustedSource) (*CloudDatabaseTrustedSource, error) {
	req, err := ts.client.NewRequest(ctx, http.MethodPost, databaseServiceName, ts.resourcePath(nodeID), &fwc)
	if err != nil {
		return nil, err
	}
...
// Delete a TrustedSource.
func (ts *cloudDatabaseTrustedSources) Delete(ctx context.Context, nodeID string) (*CloudDatabaseMessageResponse, error) {
	req, err := ts.client.NewRequest(ctx, http.MethodDelete, databaseServiceName, ts.resourcePath(nodeID), nil)
	if err != nil {
		return nil, err
	}
...
func (en *cloudDatabaseEngines) List(ctx context.Context) (*CloudDatabaseEngine, error) {
	...
	defer resp.Body.Close()
	var engines *CloudDatabaseEngine
